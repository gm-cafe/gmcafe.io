              ...
              {forgotPassword && (
                <div className="flex flex-col">
                  ...
                  <p className="text-sm text-purple">
                    You previously set a lock price of {unlockPrice} Ξ. By selecting the checkbox
                    you agree to pay the lock price instead of unlocking your moo with a password.
                  </p>
                </div>
              )}
