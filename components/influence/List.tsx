    ...
    <div className="flex h-full w-full flex-col items-center justify-center gap-6 overflow-y-auto overflow-x-clip">
      ...
      <div className="flex flex-col gap-6 overflow-y-auto px-8 md:py-4">
        {keeks.length > 0 ? (
          ...
          <h1 className="rounded-lg bg-white px-3 py-2 text-center font-gmcafe text-2xl text-purple md:text-3xl">
            You don&apos;t have any Keekusaurs that you can influence.
          </h1>
        )}
      </div>
